...
def main():
    ...
    #Page description
    st.markdown("This is an app that allows you to build your own machine learning models using a pre-determined dataset (the Indonesian Family Life Survey), and evaluate them. ") 
    st.markdown("The dataset includes 14 feature columns from 2007 used to predict the target variable, financial inclusion in 2014. This includes assets, consumption, housing, and wealth variables. ")
